...
<div class="container">
    ...
    <form>
        ...
        <div class="button-container">
            <a href="../16_insurance/chart_mva_drop.php" class="button">Motor Claim</a>
            <a href="../16_insurance/send_email_damage_1.php" class="button">Damages Claim</a>
        </div>
