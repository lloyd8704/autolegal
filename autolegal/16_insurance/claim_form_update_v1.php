...
<div class="container_reference">
  ...
  <h2>Update Claim Details</h2><br><br>
        ...
        $.ajax({
          ...
          success: function(response) {
            if (response == "form_one") {
              ...
              window.location.href = "../16_insurance/claim_form_update_v3a.php";
            } else if (response == "form_two") {
              // Redirect to the next php page
              window.location.href = "../16_insurance/claim_form_update_v3b.php";
            } else if (response == "form_three") {
              // Redirect to the next php page
              window.location.href = "../16_insurance/claim_form_update_v3c.php";
            } else if (response == "form_four") {
              // Redirect to the next php page
              window.location.href = "../16_insurance/claim_form_update_v3d.php";
            } else {
