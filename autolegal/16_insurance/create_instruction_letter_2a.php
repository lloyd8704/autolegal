...
<body>
  ...
  $sql = "SELECT policy_number, name, email, location, date, prescription, details, reference, prescription, 
  contact, identity, address, insured_vehicle, insured_registration, driver, driver_identity, driver_address, 
  third_party_name, third_party_contact, third_party_identity, third_party_vehicle, third_party_registration 
 FROM claim_form WHERE reference='$reference'";
...
echo "Third Party's Tel: " . $row['third_party_contact'] . "\n";
echo "Third Party's Identity: " . $row['third_party_identity'] . "\n";
echo "Third Party's Vehicle: " . $row['third_party_vehicle'] . " - " . $row['third_party_registration'] . "\n\n";
