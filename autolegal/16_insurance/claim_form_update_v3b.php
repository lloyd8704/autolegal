...
<body>
  ...
  <div class="container">
    <form action="../16_insurance/claim_form_update_v4.php" method="post">
      ...
      <textarea id="details" name="details" rows="3" cols="30" autocomplete="off"><?php echo $row['details']; ?></textarea>

      <label for="insured_vehicle">MAKE OF VEHICLE:</label>
      <input type="text" id="third_party_vehicle" name="insured_vehicle" value="<?php echo $row['insured_vehicle']; ?>" autocomplete="off">

      <label for="insured_registration">REGISTRATION NO:</label>
      <input type="text" id="third_party_registration" name="insured_registration" value="<?php echo $row['insured_registration']; ?>" autocomplete="off">
      ...
      <input type="text" id="third_party_name" name="second_driver_name" value="<?php echo $row['second_driver_name']; ?>" autocomplete="off">

      <label for="third_party_contact">TEL OF DRIVER 2:</label>
      <input type="text" id="third_party_contact" name="second_driver_contact" value="<?php echo $row['second_driver_contact']; ?>" autocomplete="off">

      <label for="second_driver_identity">ID NO OF DRIVER 2:</label>
      <input type="text" id="second_driver_identity" name="second_driver_identity" value="<?php echo $row['second_driver_identity']; ?>" autocomplete="off">


      <label for="third_party_vehicle">MAKE OF VEHICLE:</label>
      <input type="text" id="third_party_vehicle" name="second_driver_vehicle" value="<?php echo $row['second_driver_vehicle']; ?>" autocomplete="off">

      <label for="third_party_registration">REGISTRATION NO:</label>
      <input type="text" id="third_party_registration" name="second_driver_registration" value="<?php echo $row['second_driver_registration']; ?>" autocomplete="off">
