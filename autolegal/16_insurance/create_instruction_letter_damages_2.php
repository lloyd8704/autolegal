...
<body>
  ...
  location, quantum, third_party_name, third_party_contact, third_party_address, third_party_email,
  details, policy_number FROM damage_claim WHERE reference='$reference'";
...
<form action="../16_insurance/create_instruction_letter_damages_3.php" method="post">

  <div class="form-group">
    <textarea id="instructions" name="instructions" autocomplete="off" rows="22" cols="50">
Dear ______,

<?php echo "RE: " . strtoupper($row['company_name']) . " / " . strtoupper($row['third_party_name']) . "\n"; ?>
...
<?php
echo "Insured: " . $row['company_name'] . "\n";
echo "Insured's address: " . $row['address'] . "\n\n";
echo "Date of Incident: " . $row['date'] . "\n";
echo "Prescription: " . $row['prescription'] . "\n\n";
echo "Place of Incident: " . $row['location'] . "\n";
echo "Details of the Incident: " .  "\n\n" . $row['details'] . "\n\n";
echo "Third Party: " . $row['third_party_name'] . "\n";
echo "Third Party's address: " . $row['third_party_address'] . "\n\n";
