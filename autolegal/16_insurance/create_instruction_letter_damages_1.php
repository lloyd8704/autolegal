...
<div class="container_reference">
  ...
  <form action="../16_insurance/create_instruction_letter_damages_2.php" id="myForm" method="post">
    <div class="home-icon">
  ...
  <script>
    $(document).ready(function() {
      $("#myForm").submit(function(event) {
        ...
        $.ajax({
          url: "../16_insurance/reference_check_damage_form.php",
          type: "POST",
          data: formData,
          success: function(response) {
            if (response == "success") {
              // Redirect to the next php page
              window.location.href = "../16_insurance/create_instruction_letter_damages_2.php";
            } else {
