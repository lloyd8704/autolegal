...
<div class="container_reference">
  ...
  <h2>View Claim Details</h2><br><br>
  <form action="../16_insurance/view_damage_claim_3.php" method="post" id="myForm">
    <div class="home-icon">
  ...
  <script>
    $(document).ready(function() {
      $("#myForm").submit(function(event) {
        ...
        $.ajax({
          url: "../16_insurance/view_damage_claim_2.php",
          type: "POST",
          data: formData,
          success: function(response) {
            if (response == "success") {
              // Redirect to the next php page
              window.location.href = "../16_insurance/view_damage_claim_3.php";
            } else {
