  ...
  <script type="text/javascript">
    ...
    function drawChart() {
      ...
      if (isset($_POST['submit'])) {
        ...
        // Prepare the SQL statement to select the count of losses grouped by date, ordered by date
        $stmt = $conn->prepare("
        ...
        $stmt->bind_param("i", $year); // Assuming the year is an integer
        $stmt->execute();
        ...
        // Build the data table and calculate the total count
      ...
      // Set chart options
      var options = {
        title: 'A Total of <?php echo $totalCount; ?> Claims for <?php echo $year; ?> ',
        titleTextStyle: {
          fontSize: 18,
          bold: true,
          textAlign: 'center'
