...
<body>
  ...
  details FROM claim_form WHERE reference='$reference'";
...
echo "Insured's Driver: " . $row['driver'] . "\n";
echo "Driver's Tel: " . $row['driver_contact'] . "\n";
echo "Driver's Identity: " . $row['driver_identity'] . "\n";
