...
<div class="container_reference">
  ...
  <h2>Create Instruction Letter</h2><br>
  <form action="../16_insurance/create_instruction_letter_2.php" id="myForm" method="post">
    <div class="home-icon">
...
<script>
  $(document).ready(function() {
    $("#myForm").submit(function(event) {
      ...
      $.ajax({
        url: "../16_insurance/claim_form_update_v2.php",
        type: "POST",
        data: formData,
        success: function(response) {
          if (response == "form_one") {
            // Redirect to the next php page
            window.location.href = "../16_insurance/create_instruction_letter_2a.php";
          } else if (response == "form_two") {
            // Redirect to the next php page
            window.location.href = "../16_insurance/create_instruction_letter_2b.php";
          } else if (response == "form_three") {
            // Redirect to the next php page
            window.location.href = "../16_insurance/create_instruction_letter_2c.php";
          } else if (response == "form_four") {
            // Redirect to the next php page
            window.location.href = "../16_insurance/create_instruction_letter_2d.php";
          } else {
