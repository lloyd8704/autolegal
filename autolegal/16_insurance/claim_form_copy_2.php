...
$sql = "INSERT INTO claim_form (reference, policy_number, name, email, contact, identity, address, insured_vehicle, 
insured_registration, driver, driver_identity, driver_address, location, date, prescription, third_party_name, 
...
$html_template = file_get_contents('../16_insurance/claim_form_copy_3.html');
...
<body>
    <div id="container">
        ...
        <a href="../16_insurance/damage_claim_form_copy_1.html">Back to home</a>
    </div>
