  ...
  <div class="container">
    ...
    <form>
      ...
      <div class="button-container">
        ...
        <a href="../16_insurance/search_mva.php" class="button">Motor Claims</a>
        <a href="../16_insurance/search_damage.php" class="button">Damage Claims</a>
      </div>
    </form>
  </div>
  <style>
