...
<body>
  <div class="container">
    <!--<img src="../11_Images/AI-LOGO.png" class="logo" alt="Letter and email"><br> -->
    ...
    <form id="myForm" action="../16_insurance/create_aol_damage_3.php" method="post">
      <div class="input-container">
        <div class="input-field-container">
          <label>Row 1:&nbsp;</label>
          <input class="inputField" type="text" name="input1" id="input1" placeholder="Description" autocomplete="off" style="text-transform: capitalize;">
          <label>R</label>
          <input class="inputField" type="text" name="amount1" id="amount1" placeholder="Amount" autocomplete="off" required><span class="add-icon" onclick="addInputField()" required></span>
        </div>
