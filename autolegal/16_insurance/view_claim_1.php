...
<ul>
  ...
  <body>
    ...
    <li><a class="active" href="view_claim_select.php">View</a></li>
...
<script>
  $(document).ready(function() {
    $("#myForm").submit(function(event) {
      ...
      $.ajax({
        url: "../16_insurance/reference_check_claim.php",
        type: "POST",
        data: formData,
        success: function(response) {
          if (response == "form_one") {
            // Redirect to the next php page
            window.location.href = "../16_insurance/view_claim_2.php";
          } else if (response == "form_two") {
            // Redirect to the next php page
            window.location.href = "../16_insurance/view_claim_3.php";
          } else if (response == "form_three") {
            // Redirect to the next php page
            window.location.href = "../16_insurance/view_claim_4.php";
          } else if (response == "form_four") {
            // Redirect to the next php page
            window.location.href = "../16_insurance/view_claim_5.php";
          } else {
