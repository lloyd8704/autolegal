...
<body>
  ...
  <div class="container_reference">
    ...
    <h2>Create Letter of Instruction</h2>
    <form>
      ...
      <div class="button-container">
        <a href="../16_insurance/create_instruction_letter_1.php" class="button">Motor Claim</a>
        <a href="../16_insurance/create_instruction_letter_damages_1.php" class="button">Damages Claim</a>
      </div>
