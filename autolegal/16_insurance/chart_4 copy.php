...
<body>
    ...
    ");
        ...
        while ($row = $result->fetch_assoc()) {
            ...
            $count = $row['count'];
            $data[] = "data.addRow(['$province', $count]);";
    ...
    <head>
        ...
        <script type="text/javascript">
            ...
            function drawChart() {
                ...
                if (isset($_POST['submit'])) {
                    ...
                    // Prepare the SQL statement to select the count of losses grouped by age
                    $stmt = $conn->prepare("
      ...
      ORDER BY age");
                ...
                // Set chart options
                var options = {
                    title: 'Total Loss Occurrences by Age',
                    titleTextStyle: {
                        fontSize: 18,
                        bold: true,
                        textAlign: 'center'
