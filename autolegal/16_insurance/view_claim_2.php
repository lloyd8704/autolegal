...
third_party_identity, third_party_vehicle, third_party_registration FROM claim_form 
...
<body>
    ...
    <div class="container"><br>
        <form>
            ...
            <textarea id="details" name="details" rows="3" cols="30" readonly><?php echo $row['details']; ?></textarea>
