...
$sql = "INSERT INTO collision_reports (reference, name, email, location, date, details, prescription, contact, identity,
address, insured_vehicle, insured_registration, driver, driver_identity, driver_address, third_party_name, 
third_party_address, third_party_vehicle, third_party_registration) 
VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)";
...
$identity = mysqli_real_escape_string($conn, $_POST['indentity']);
$address = mysqli_real_escape_string($conn, $_POST['address']);
$insured_vehicle = mysqli_real_escape_string($conn, $_POST['insured_vehicle']);
$insured_registration = mysqli_real_escape_string($conn, $_POST['insured_registration']);
...
$third_party_name = mysqli_real_escape_string($conn, $_POST['third_party_name']);
$third_party_address = mysqli_real_escape_string($conn, $_POST['third_party_address']);
$third_party_vehicle = mysqli_real_escape_string($conn, $_POST['third_party_vehicle']);
$third_party_registration = mysqli_real_escape_string($conn, $_POST['third_party_registration']);
