...
<body style="background-color: black">
    ...
    <form action="../3_Correspondence/send_letter_2.php" id="myForm" method="post">
...
<script>
    $(document).ready(function() {
        $("#myForm").submit(function(event) {
            ...
            $.ajax({
                url: "../3_Correspondence/send_letter_check.php",
                type: "POST",
                data: formData,
                success: function(response) {
                    if (response == "success") {
                        // Redirect to the next php page
                        window.location.href = "../3_Correspondence/send_letter_2.php";
                    } else {
