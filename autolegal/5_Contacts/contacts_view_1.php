...
<body style="background-color: black">
  ...
  <body>
    <form action="../5_Contacts/contacts_view_2.php" id="myForm" method="post">
    ...
    <img src="../11_Images/hex2.png" id="hexagons" class="hexagons2" alt="Outline of two hexagons">
    <div id="message"></div>
  </body>
  <script>
    $(document).ready(function() {
      $("#myForm").submit(function(event) {
        ...
        $.ajax({
          url: "../5_Contacts/contacts_view_check.php",
          type: "POST",
          data: formData,
          success: function(response) {
            if (response == "success") {
              // Redirect to the next php page
              window.location.href = "../5_Contacts/contacts_view_2.php";
            } else {
