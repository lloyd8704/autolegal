...
<body style="background-color: black">
    ...
    <form action="../4_Pleadings/pleadings_create_4a.php" id="myForm" method="post">
        ...
        <div>
            <a class="btnsearch" tabindex="1" href="../4_Pleadings/Index.php">❮&nbsp&nbspBack</a>
        </div>
        </div>
    </form>
...
<script>
    $(document).ready(function() {
        $("#myForm").submit(function(event) {
            ...
            $.ajax({
                url: "../4_Pleadings/pleadings_create_check.php",
                type: "POST",
                data: formData,
                success: function(response) {
                    if (response == "success") {
                        // Redirect to the next php page
                        window.location.href = "../4_Pleadings/pleadings_create_1.php";
                    } else {
