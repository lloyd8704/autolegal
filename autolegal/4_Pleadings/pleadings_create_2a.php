...
<div id="test">
    ...
    <body style="background-color: black">
        ...
        <br><br>
        <form action="../4_Pleadings/pleadings_create_3.php" method="post">
            <fieldset>
                <legend>
                ...
                <datalist id="pleadings" role="listbox">
                    ...
                    <option value="Rule 55 Amendment">Amendment - Rule 55A</option>
                    <option value="Notice of Objection ito Rule 55 - Code P0">Amendment - Objection</option>
                    ...
                    <option value="Consent to Recission of Default Judgment - Code PD">Consent to Recission of Default Judgment</option>
                    ...
                    <option value="Pretrial - Request for Pre-trial">Pre-trial - Request for Pre-trial</option>
                    ...
                    <option value="Rule 23 Notices - Code P0">Rule 23 Notices</option>
                    <option value="Rule 23(6)(a) - Notice to Produce">Rule 23(6)(a) - Notice to Produce</option>
                    <option value="Rule 23(6)(b) - Notice to Inspect">Rule 23(6)(b) - Notice to Inspect</option>
                    <option value="Rule 23(6)(b) - Notice to Inspect - Objection">Rule 23(6)(b) - Notice to Inspect - Objection</option>
                    <option value="Rule 23(3)&(6) Notices - Code P0">Rule 23(3) & (6) Notices - Request for Additional Docs</option>
                    <option value="Rule 23(15) Notice - Code P0">Rule 23(15) Notice - Call for Documents before Plea</option>
                    <option value="Rule24(9)(a)">Rule24(9)(a) - Notice Only</option>
                    <option value="Rule 24(9)(a) & (b)">Rule24(9)(a) & (b) - Notice & Summary</option>
                    <option value="Rule24(9)(b)">Rule24(9)(b) - Summary Only</option>
                    <option value="Rule 24(10)">Rule 24(10) - Photographs</option>
            ...
            <input type="hidden" name="whichcourt" value="MC">
            <div><button class="inputdropdown" type="submit">Next</div>
            <img src="../11_Images/hex.png" id="hexagons" class="hexagons" alt="Outline of three hexagons">
        </form>
        <style>
            fieldset {
                position: relative;
