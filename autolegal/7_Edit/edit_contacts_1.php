...
<body>
    ...
    <br>
    <form action="../7_Edit/edit_contacts_2.php" id="myForm" method="post">
        <label for="heading" class="searchheading">Edit Contacts:</label>
                ...
                $.ajax({
                    ...
                    success: function(response) {
                        if (response == "success") {
                            ...
                            window.location.href = "../7_Edit/edit_contacts_2.php";
                        } else {
