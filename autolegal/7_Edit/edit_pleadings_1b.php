...
<form action="../7_Edit/edit_pleadings_2b.php" method="post">
    <label for="heading" class="searchheading">Edit Names:</label>
    <div class="searchlable">
        <label for="cname">Reference number:</label>
    </div>
    <div class="col-75">
        <input type="text" class="input4" id="reference" style="text-transform:capitalize" name="reference" value="" autocomplete='off' autofocus="on" required>
    </div>
