...
<body style="background-color: black">
    ...
    if ($result->num_rows > 0) {
        ...
        <form action='../7_Edit/edit_pleadings_3e.php' method='post'>
    ...
    <div class='test2'>
        ...
        if ($number == "6P6D") {
            echo  "<span class='error'><br>You have already reached the maximum number of parties for this matter</span>";
        }
