...
<form action="../7_Edit/edit_pleadings_2c.php" method="post">
    <label for="heading" class="searchheading" id="searchheadingdetails">Edit Attorney Details:</label>
