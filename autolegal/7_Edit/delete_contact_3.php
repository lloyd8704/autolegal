...
if ($result->num_rows > 0) {
    while ($row = $result->fetch_assoc()) {
        ...
        echo "<div class='body-text1'><h1><br>You are about to delete - $ref - $name</h1></div>";
        echo "<div class='body-text1'><h1>Are you sure you want to continue?</h1></div><br>";
        echo "<a class='btncorrespondence' href='../7_Edit/delete_contact_1.php'>No</a>&nbsp&nbsp&nbsp&nbsp
        <a class='btncorrespondence' href='../7_Edit/delete_contact_4.php'>Yes</a>";
    }
}
?>
<style>
