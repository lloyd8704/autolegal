...
<body>
    ...
    <form action="../7_Edit/delete_correspondence_2.php" id="myForm" method="post">
        <label for="heading" class="searchheading">Delete Correspondence:</label>
                ...
                $.ajax({
                    ...
                    success: function(response) {
                        if (response == "success") {
                            ...
                            window.location.href = "../7_Edit/delete_correspondence_2.php";
                        } else {
