...
<body style="background-color: black">
    ...
    <form action="../7_Edit/delete_pleading_2.php" id="myForm" method="post">
        <label for="heading" class="searchheading">Delete a Pleading:</label>
        ...
        <div>
            <a class="btnsearch" tabindex="1" href="../7_Edit/delete.php">❮&nbsp&nbspBack</a>
        </div>
    </form>
    ...
    <script>
        $(document).ready(function() {
            $("#myForm").submit(function(event) {
                ...
                $.ajax({
                    url: "../7_Edit/edit_pleadings_check.php",
                    type: "POST",
                    data: formData,
                    success: function(response) {
                        if (response == "success") {
                            // Redirect to the next php page
                            window.location.href = "../7_Edit/delete_pleading_2.php";
                        } else {
