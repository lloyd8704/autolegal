...
<body>
    ...
    <br>
    <label for="heading" class="searchheading">Edit Details:</label>
    <form action="../7_Edit/edit_pleadings_2a.php" id="myForm" method="post">
                ...
                $.ajax({
                    ...
                    success: function(response) {
                        if (response == "success") {
                            ...
                            window.location.href = "../7_Edit/edit_pleadings_2a.php";
                        } else {
