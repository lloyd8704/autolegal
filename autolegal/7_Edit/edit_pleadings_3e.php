...
$plaintiffs = filter_var($_POST['plaintiffs'], FILTER_SANITIZE_FULL_SPECIAL_CHARS);
$defendants = filter_var($_POST['defendants'], FILTER_SANITIZE_FULL_SPECIAL_CHARS);
...
<span class='success'><br>The parties were successfully added!</span><br><br>
    <form action='../7_Edit/edit_pleadings_3e1.php' method='post'>
