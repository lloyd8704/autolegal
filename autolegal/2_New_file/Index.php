...
<body style="background-color: black;">
  <div id="test">
    ...
    <div class="body-text1">
      <h1>What database would you like to create?</h1>
    </div>
    <img src="../11_Images/newfilesicons.png" class="center" alt="Image of letters and email icon"><br>
    <div class="buttons-container">
      <a href="../2_New_file/New_file_correspondence.php">Correspondence</a>
      <a href="../2_New_file/New_file_pleadings.php">Pleadings</a>
    </div>
  </div>
</body>
